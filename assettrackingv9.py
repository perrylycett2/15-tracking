...
- The active RFID pilot hallway is a smaller segment centered on a real south
  corridor from the attached SJH Level 1 South floorplan.
...
SEGMENTS: Dict[str, SegmentSpec] = {
    # Smaller active pilot on the true centerline of the south public corridor.
    "PILOT": SegmentSpec(
    ...
    # Top-center east/west corridor outside F1-118 / F1-114 / F1-104.
